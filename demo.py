...
# print(df2)
df3 = df2[['mat_tien','so_tang','do_rong_duong','dien_tich','so_do','ten_duong', 'gia_m2']]
...
target = df2[['mat_tien','so_tang','do_rong_duong','dien_tich','so_do','ten_duong', 'gia_m2']]
X, y = target[['mat_tien','so_tang','do_rong_duong','dien_tich','so_do','ten_duong']], df2['gia_m2']
